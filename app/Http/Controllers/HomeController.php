    ...
    public function __invoke(Request $request): View
    {
        ...
        $testimonials = [
            [
                ...
                'author_name'  => 'Sarah L',
                'author_image' => Vite::asset('resources/images/profile-picture-1.webp'),
            ],
            [
                ...
                'author_name'  => 'Jason M',
                'author_image' => Vite::asset('resources/images/profile-picture-2.webp'),
            ],
            [
                ...
                'author_name'  => 'Emily R',
                'author_image' => Vite::asset('resources/images/profile-picture-3.webp'),
            ],
            [
                ...
                'author_image' => Vite::asset('resources/images/profile-picture-4.webp'),
            ],
        ];
