...
final class TestimonialSeeder extends Seeder
{
    ...
    public function run(): void
    {
        foreach ($this->testimonials() as $testimonial) {
            $authorPicture = Arr::pull($testimonial, 'author_picture');

            $testimonial = Testimonial::create($testimonial);

            $testimonial
                ->addMedia(resource_path("images/testimonials/{$authorPicture}"))
                ->preservingOriginal()
                ->toMediaCollection('author-picture');
        }
    }
    ...
    private function testimonials(): array
    {
        return [
            [
                ...
                'author_name'    => 'Sarah L',
                'author_picture' => 'author-picture-1.webp',
            ],
            [
                'quote' => [
                ...
                'author_name'    => 'Jason M',
                'author_picture' => 'author-picture-2.webp',
            ],
            [
                'quote' => [
                ...
                'author_name'    => 'Emily R',
                'author_picture' => 'author-picture-3.webp',
            ],
            [
                'quote' => [
                ...
                'author_picture' => 'author-picture-4.webp',
            ],
            [
                'quote' => [
